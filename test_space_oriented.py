...
from vol_generation_script import init, clear_scene, space_oriented_algorithm, bounding_box
...
TEST_VOLS = {
    ...
    "Diamond": 1546155.8117, "Sponge": 5925925.82, "tk": 20238706.8905, "st": 734731.5605,
    "te": 513200.2638, "tp": 25297666.767, "dmesh": 1638237.8412, "Pyramid": 770000.0461}

LOCATIONS = [
    [(x, y, 2) for x in [6, 2, -2, -6] for y in [4, 0, -4]], 
    [(x, y, -2) for x in [6, 2, -2, -6] for y in [4, 0, -4]]]
    # (4, 2, -2), (4, -2, -2), (0, 2, -2), (0, -2, -2), (-4, 2, -2),
    # (-4, -2, -2), (4, 2, 2), (4, -2, 2), (0, 2, 2), (0, -2, 2), (-4, 2, 2),
    # (-4, -2, 2)]
...
def vol_test_space_oriented(object_list, num_x, num_y, num_z, threshold,
    ...
    for j, prim in enumerate(methods):
        for i, (name, obj) in enumerate(object_list):
            ...
            # minx, maxx, miny, maxy, minz, maxz = update_location(
            #     minx, maxx, miny, maxy, minz, maxz, LOCATIONS[i])
            ...
            vol = space_oriented_algorithm(
                [ind, ind], num_x, num_y, num_z, threshold, minx, maxx, miny,
...
def main():
    ...
    length, width, height = 0.03, 0.03, 0.05
